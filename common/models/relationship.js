      ...
      .then(function (sourcePerson) {
        ...
        return app.models.person
          ...
          .then(function (targetPerson) {
            ...
            if (targetPerson.type === 'LNG_REFERENCE_DATA_CATEGORY_PERSON_TYPE_CONTACT_OF_CONTACT' &&
            sourcePerson.type !== 'LNG_REFERENCE_DATA_CATEGORY_PERSON_TYPE_CONTACT') {
              // otherwise stop with error
              throw app.utils.apiError.getError('INVALID_RELATIONSHIP_SOURCE_TYPE', {
                type: sourcePerson.type,
                allowedTypes: ['LNG_REFERENCE_DATA_CATEGORY_PERSON_TYPE_CONTACT']
              });
            }
