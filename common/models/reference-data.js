...
module.exports = function (ReferenceData) {
  ...
  ReferenceData.availableCategories = [
    ...
    {
      'id': 'LNG_REFERENCE_DATA_CATEGORY_VACCINATION_STATUS',
      'name': 'LNG_REFERENCE_DATA_CATEGORY_VACCINATION_STATUS',
      'description': 'LNG_REFERENCE_DATA_CATEGORY_VACCINATION_STATUS_DESCRIPTION'
    },
    {
