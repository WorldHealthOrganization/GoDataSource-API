...
module.exports = function (ReferenceData) {
  ...
  ReferenceData.availableCategories = [
    ...
    {
      'id': 'LNG_REFERENCE_DATA_CONTACT_FOLLOW_UP_STATUS_TYPE',
      'name': 'LNG_REFERENCE_DATA_CONTACT_FOLLOW_UP_STATUS_TYPE',
      'description': 'LNG_REFERENCE_DATA_CONTACT_FOLLOW_UP_STATUS_TYPE_DESCRIPTION'
    }
  ];
