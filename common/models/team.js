...
module.exports = function (Team) {
  ...
  Team.fieldLabelsMap = Object.assign({}, Team.fieldLabelsMap, {
    ...
    createdOn: 'LNG_TEAM_FIELD_LABEL_CREATED_ON',
    createdAt: 'LNG_TEAM_FIELD_LABEL_CREATED_AT',
    createdBy: 'LNG_TEAM_FIELD_LABEL_CREATED_BY',
    updatedAt: 'LNG_TEAM_FIELD_LABEL_UPDATED_AT',
    updatedBy: 'LNG_TEAM_FIELD_LABEL_UPDATED_BY',
    deleted: 'LNG_TEAM_FIELD_LABEL_DELETED',
    deletedAt: 'LNG_TEAM_FIELD_LABEL_DELETED_AT',
